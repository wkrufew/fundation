    ...
    <div style="padding: 80px; ">
        <div class="container" >
            <div class="card text-center" >
                {!! Form::model($integrante, ['route' => ['integrantes.update',$integrante], 'method' => 'put', 'files' => true, 'autocomplete' => 'off']) !!}
                ...
                <div class="card-body ">
                    ...
                    <div class="text-center">
                        @if ($integrante->foto)
                            <img id="picture" style="border-radius: 8px;" src="{{Storage::url($integrante->foto)}}" width="100px" alt="">
                        @else
