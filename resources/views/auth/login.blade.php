<x-guest-layout>
    ...
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-6 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img class="w-16 md:w-20 hidden md:block" src="{{ asset('fotos/logo_fundation.png') }}" alt="">
                    </div>
                    
                    <a class="text-3xl text-indigo-900 font-display text-center xl:text-5xl tracking-wide font-semibold" href="{{route('home')}}">FUNDECOM</a>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-3xl text-purple-700 font-display font-semibold lg:text-left xl:text-4xl
                xl:text-bold">Personal Administrativo</h2>
                <div class="mt-12">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-purple-700 tracking-wide ml-4">Correo</div>
                            <x-jet-input id="email" class="block mt-1 w-full rounded-full" type="email" name="email" :value="old('email')" required autofocus />
                        </div>
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-bold text-purple-700 tracking-wide ml-4">
                                    Contraseña
                                </div>
                                
                            </div>
                            <x-jet-input id="password" class="block mt-1 w-full rounded-full " type="password" name="password" required autocomplete="current-password" />
                        </div>
                        <div class="mt-10">
                            <button class="bg-purple-500 text-gray-50 p-4 w-full rounded-full tracking-wide
                            font-semibold font-display focus:outline-none text-md focus:shadow-outline hover:bg-purple-600
                            shadow-xl">
                                Iniciar
                            </button>
                        </div>
        ...
        <div class="hidden lg:flex items-center justify-center bg-purple-200 flex-1 h-screen">
